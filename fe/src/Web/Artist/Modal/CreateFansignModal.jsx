  ...
  return (
    <>
      <Modal
        ...
        style={customStyle}
      >
        <div className="flex font-jamsil bg-black overflow-hidden ps-3 pt-5">
          {stars.map((star) => (
            <div
              key={star.id}
              className="star"
          ...
          <div className="w-1/2 pt-[2.5%] h-[90%] flex flex-col justify-between items-align">
            ...
            <ImgUpload img={null} uploadImg={uploadImg} className="ml-10" />
          </div>
          <div className="w-1/2 h-[auto]">
            <div className="font-jamsil pl-3">
              <div className="pt-5 flex flex-col">
                <label className="text-hot-pink pb-1 text-25">공지사항 </label>
                <CKEditor
