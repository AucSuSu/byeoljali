...
public class MemberFansignResponseDto {
    ...
    public MemberFansignResponseDto(Long artistFansignId, Long memberFansignId, String information, String title, String memberName, Long artistId, String posterImageUrl, FansignStatus status, LocalDateTime startApplyTime, LocalDateTime endApplyTime, LocalDateTime startFansignTime) {
