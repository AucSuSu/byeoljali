...
public class ApplyPageDto { // 응모 페이지에서 보여야 할 값
    ...
    public ApplyPageDto(Long memberfansignId, String posterImageUrl, String artistFansignTitle, String memberName, LocalDateTime startFansignTime, boolean isWon, FansignStatus fansignStatus) {
