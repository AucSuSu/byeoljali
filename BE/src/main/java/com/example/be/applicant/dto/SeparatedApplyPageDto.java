...
public class SeparatedApplyPageDto {
    ...
    public SeparatedApplyPageDto(Long memberfansignId, String posterImageUrl, String artistFansignTitle, String memberName, LocalDateTime startFansignTime, FansignStatus fansignStatus) {
